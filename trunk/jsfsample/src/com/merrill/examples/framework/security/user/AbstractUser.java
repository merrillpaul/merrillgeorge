/**
 * @(#) AbstractUser.java 1.0 Apr 11, 2007
...
public abstract class AbstractUser implements BasePrincipal {

	
	private static final String TYPE_NAME="user.principal";
	/* (non-Javadoc)
