/**
 * @(#) CaptchaToken.java 1.0 Apr 9, 2007
 ...
 *
 */
package com.merrill.examples.framework.security.token.captcha;
...
public interface CaptchaToken extends Token {
	BufferedImage getTokenImage();
}
