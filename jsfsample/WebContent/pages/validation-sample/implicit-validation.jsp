...
<TABLE BORDER=5 ALIGN="CENTER">
  ...
  <h:form>
	  ...
	  <div>
	  	<span> User Id :</span>
	  	<span> <h:inputText value="#{bidForm1.userId}" id="userId" required="true"/></span>
	  	<span><h:message for="userId" styleClass="RED"></h:message></span>
	  </div>
	  
	   <div>
	  	<span> Keyword :</span>
	  	<span> <h:inputText value="#{bidForm1.keyWord}" id="keyWord" required="true"/></span>
	  	<span><h:message for="keyWord" styleClass="RED"></h:message> </span>
	  </div>
	  
	   <div>
	  	<span> Bid Amount :</span>
	  	<span> <h:inputText value="#{bidForm1.bidAmount}" id="bidAmount"/></span>
	  	<span><h:message for="bidAmount" styleClass="RED"></h:message> </span>
	  </div>
	  
	   <div>
	  	<span> Bid Duration :</span>
	  	<span> <h:inputText value="#{bidForm1.bidDuration}" id="bidDuration"/></span>
